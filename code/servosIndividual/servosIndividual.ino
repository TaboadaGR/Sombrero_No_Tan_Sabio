...
const int ANGLE_MIN_RANDOM = 20;  // Ángulo mínimo para el movimiento aleatorio
const int ANGLE_MAX_RANDOM = 160; // Ángulo máximo para el movimiento aleatorio
const int ANGLE_STOP = 0;         // <--- CAMBIO AQUÍ: Ángulo de inicio/parada a 0 grados

// Variables para el control de tiempo del movimiento aleatorio
unsigned long lastRandomMoveTime = 0;
const long RANDOM_MOVE_INTERVAL = 100; // Mover cada 100 milisegundos (ajusta a tu gusto)
